...
function App() {
  ...
  const passiveVoiceFrequency = useSelector((state: RootState) => state.editor.passiveVoiceFrequency)
  ...
  return (
    <div className="app">
      ...
      <FrequencyPanel title="Passive Voice" data={passiveVoiceFrequency} barClass="bar bar--passive" />
    </div>
  )
}
