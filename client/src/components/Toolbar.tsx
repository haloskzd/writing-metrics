...
import { processText, processFillers, processFilterWords, processAdverbs, processSentenceLengths, processRepeatedPhrases, processPassiveVoice, toggleViewMode } from '../store/editorSlice'
...
export default function Toolbar() {
  ...
  return (
    <div className="toolbar">
      ...
      <button
        className="toolbar-btn"
        title="Analyze Passive Voice"
        aria-label="Analyze Passive Voice"
        onClick={() => dispatch(processPassiveVoice())}
      >
        <Ghost size={22} />
      </button>
      <button
